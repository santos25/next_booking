...
import faqImg from "/public/images/faq-2.jpg";
import mokaup from "/public/images/mokaup/mokup-9.png";
import shape from "/public/images/shape/shape-16.png";

const Faq = () => {
  return (
    <>
      <div className="faq-area pb-175">
          ...
          <div className="row align-items-center">
            ...
            >
              <div className="faq-img-2 position-relative z-1">
                ...
                <Image
                  src={mokaup}
                  className="mokup-9 position-absolute top-0 start-0 end-0 w-100 h-100"
                  alt="mokup-9"
                />
