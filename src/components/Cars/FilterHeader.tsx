    ...
    <>
      <div className="d-xl-flex justify-content-between align-items-center mb-70">
        <div className="section-title mb-0 left-title">
          <h2>Cars In Toronto</h2>
          <p>130 Cars  ·  Aug 10 - 18</p>
        </div>

        <ul className="p-0 mb-0 mt-3 mt-xl-0 list-unstyled d-lg-flex align-items-center filter-drop">
          <li className="ms-0">
            <select className="form-select form-control">
              <option defaultValue="0">Car Type</option>
              <option defaultValue="1">Honda Civic</option>
              <option defaultValue="2">Hyundai Elantra</option>
              <option defaultValue="3">Toyota RAV4</option>
              <option defaultValue="4">Toyota Corolla</option>
              <option defaultValue="5">Tesla Model 3</option>
            </select>
          </li>
          <li>
          ...
          <li>
            <select className="form-select form-control">
              <option defaultValue="0">Guests & Bags</option>
