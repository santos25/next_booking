...
import testimonialImg from "/public/images/testimonial-img-4.jpg";
import mokaup from "/public/images/mokaup/mokup-13.png"; 
...
const TestimonialSliderFour: React.FC = () => {
  return (
    <>
      <div className="testimonial-area ptb-175 bg-color-fff7ed">
          ...
          <div className="row align-items-center">
            ...
            <div className="col-lg-6">
              <div className="testimonial-img-three mb-4 mb-lg-0 position-relative">
                ...
                <Image
                  src={mokaup}
                  className="mokup-13 position-absolute top-0 start-0 end-0 w-100"
                  alt="mokup"
                /> 
              </div>
            </div>
